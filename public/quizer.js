...
(() => {
    ...
    let taskDescription = readTaskDescription();
    let bestWorkingCode = readBestSolution();
    ...
    function finishSession(timeout) {
        ...
        document.getElementById("finish-description").innerHTML = msg;
    }
    ...
    function startEditor() {
        ...
        require([...libs, 'vs/editor/editor.main'], (...libSource) => {
            if (!taskDescription)
                throw new Error("taskDescription missing");
